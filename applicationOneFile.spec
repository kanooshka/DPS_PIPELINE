...
a.datas += [('ui/seqDescription.ui', 'DPSPipeline/widgets/attributeeditorwidget/ui/AEproject.ui', 'DATA')]
a.datas += [('ui/seqDescription.ui', 'DPSPipeline/widgets/attributeeditorwidget/ui/AEshot.ui', 'DATA')]
